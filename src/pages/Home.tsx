  ...
  return (
    <div className="min-h-screen flex justify-center px-[12px]">
      ...
      <div className="w-full max-w-[768px]">
        ...
        <div className="mt-[40px] bg-[#27292D] border-[2px] border-[#35373B] rounded-[8px] px-[20px] py-[24px]">
        ...
        {postData.map((post, key) => (
          <div
            className="my-[16px] bg-[#27292D] border-[2px] border-[#35373B] rounded-[8px] px-[20px] py-[24px]"
            key={key}
          >
